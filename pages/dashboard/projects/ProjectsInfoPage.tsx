...
import {
  ...
  patterns,
} from "@/components/app/dashboard/projects/ProjectsInfo";
import { ProjectOptions, ProjectsFilterkey } from "@/components/types";
...
const ProjectsInfoPage = () => {
  ...
  const [projectInfo, setProjectInfo] =
    useState<Projects>(initialProjectsState);
  ...
  function addProject(): void | false {
    ...
    if (
      projectInfo.price < 0 ||
      projectInfo.team < 1 ||
      !patterns.finishDate.test(projectInfo.finishDate)
    ) {
        ...
        <Select
          ...
          onChange={(e) =>
            setProjectOptions((prevState) => ({
              filterKey: e.target.value as ProjectsFilterkey,
              filterValue: "",
            }))
          }
        >
