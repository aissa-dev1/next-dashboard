...
import {
  ...
  patterns,
} from "@/components/app/dashboard/reminders/RemindersInfo";
import { ReminderOptions, RemindersFilterKey } from "@/components/types";
        ...
        <Select
          ...
          onChange={(e) =>
            setReminderOptions((prevState) => ({
              filterKey: e.target.value as RemindersFilterKey,
              filterValue: "",
            }))
          }
        >
